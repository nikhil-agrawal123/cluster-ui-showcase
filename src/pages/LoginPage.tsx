  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Form */}
        <div className="bg-card rounded-2xl shadow-surface p-6 space-y-4">
          {isSignUp && (
            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }}>
              <label className="text-xs font-medium text-foreground mb-1.5 block">Username</label>
              <Input placeholder="Choose a username" className="h-10 rounded-lg bg-muted border-0 text-sm focus-visible:ring-1 focus-visible:ring-accent" />
            </motion.div>
          )}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input placeholder="you@example.com" className="pl-9 h-10 rounded-lg bg-muted border-0 text-sm focus-visible:ring-1 focus-visible:ring-accent" />
            </div>
          </div>
          ...
          <Link to="/">
            <Button className="w-full bg-accent text-accent-foreground hover:bg-accent/90 rounded-xl h-10 font-medium text-sm gap-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-10 rounded-xl text-sm font-medium">
